...
const colorOptions = [
  { name: "White", src: "/images/model-04-white.jpg" },
  { name: "Black", src: "/images/model-04-black.jpg" },
  { name: "Blue", src: "/images/model-04-blue.jpg" },
  { name: "Green", src: "/images/model-04-green.jpg" },
];

const specifications = [
  { label: "Dimensions", value: "30 × 100 × 3.4 cm" },
  { label: "Weight", value: "1.7 kg / piece" },
  { label: "Performance", value: "Weather resistant · UV resistant · Long-lasting outdoor use" },
];

const applications = [
  { thai: "สวนและทางเดิน", english: "GARDEN & WALKWAYS", description: "Suitable for creating clean and practical garden paths." },
  { thai: "โรงเรือน", english: "GREENHOUSE", description: "Ideal for greenhouse floors and growing areas." },
  { thai: "ฟาร์ม", english: "FARM", description: "Suitable for general farm flooring and utility zones." },
  { thai: "รองกระถางต้นไม้", english: "UNDER POTS", description: "Helps keep pots elevated and organized." },
  { thai: "พื้นที่เปียก", english: "WET AREAS", description: "Open-slot design supports drainage and keeps surfaces cleaner." },
  { thai: "งานอเนกประสงค์", english: "UTILITY AREAS", description: "Flexible flooring solution for multiple everyday applications." },
];

export default function Model04Page() {
    ...
    <main id="top" className="min-h-screen bg-[#F7F6F1] text-[#26352C]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10 lg:px-10 lg:py-16">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-start lg:gap-20">
          ...
          <div className="lg:pt-4">
            <p className="text-xs uppercase tracking-[0.26em] text-[#64806C]">Flooring System / Model 04</p>
            ...
            <p className="mt-8 max-w-xl text-base leading-8 text-[#68766C]">แผ่นปูพื้นจัดสวนขนาด 30 × 100 × 3.4 ซม. สำหรับงานใช้งานทั่วไป ออกแบบให้แข็งแรง ใช้งานง่าย ระบายน้ำได้ดี ทนแดด ทนฝน และเหมาะกับการใช้งานในสวน โรงเรือน ฟาร์ม ทางเดิน พื้นที่เปียก และพื้นที่อเนกประสงค์</p>
            <p className="mt-4 max-w-md text-sm leading-7 text-[#8A948C]">Versatile modular plastic flooring designed for everyday garden, greenhouse, farm, walkway, wet-area, and utility applications.</p>
      ...
      <section className="border-y border-[#26352C]/10 bg-[#EEF1EB]">
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-10 lg:py-16">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight tracking-[-0.04em] sm:text-4xl">One versatile floor.<br />Many practical uses.</h2>
          </div>
      ...
      <nav aria-label="Product navigation" className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-10 text-sm text-[#476A55] sm:flex-row sm:items-center sm:justify-between lg:px-10">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:gap-8">
          <Link href="/flooring-system/model-03" className="transition hover:text-[#304539]">Previous Model — Model 03</Link>
          <Link href="/flooring-system/model-05" className="transition hover:text-[#304539]">Next Model — Model 05 →</Link>
        </div>
      </nav>
    </main>
  );
